        ...
        <form action="{{ route('karyawanUpdate', ['karyawan' => $karyawan->id]) }}" method="POST">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select form-control" name="n_posisi" id="n_posisi">
                            @foreach ($posisi as $posisi)
                                <option value="{{ $posisi->id }}"
                                    {{ $karyawan->id_posisi == $posisi->id ? 'selected' : '' }}>{{ $posisi->n_posisi }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="mb-3 row">
                    <label for="roles" class="col-sm-2 col-form-label">Posisi</label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama" name="nama"
                            placeholder="Masukkan Nama" required="required" value="{{ old('nama', $karyawan->nama) }}">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control" id="password" name="password"
                            aria-describedby="passwordHelpBlock" value="{{ old('password', $karyawan->password) }}">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="file" class="form-control form-group" name="gambar" id="gambar"
                            accept="image/*" value="{{ old('gambar', $karyawan->gambar) }}">
